...
Product: Go Security Assessment CLI (working title)
...
Artifact SBOM via container/image scanning
...
Phase 0: Core CLI, deterministic policy engine

Phase 1: CI polish, artifact SBOM support

Phase 2: AI advisory features + MCP

Phase 3: Ecosystem integrations (IDE, hooks, templates)
