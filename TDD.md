...
staticcheck - Advanced Static Analysis
  Detects dead code (U1000), deprecated APIs, and subtle bugs
...
Reads/writes .verdict/baseline.json
...
7.6 MCP Server (Implemented)

Exposes read-only domain views via Model Context Protocol:

Tools:
- verdict_scan - Run full security scan
- verdict_sast - Static analysis only
- verdict_vuln - Vulnerability scanning
- verdict_secrets - Secrets detection
- verdict_policy_check - Evaluate policy
- verdict_baseline_add - Add findings to baseline

Resources:
- verdict://config - Current configuration
- verdict://baseline - Baseline fingerprints
- verdict://engines - Available engines and status

Start with: verdict mcp serve
Add to Claude Code: claude mcp add verdictsec -- verdict mcp serve
